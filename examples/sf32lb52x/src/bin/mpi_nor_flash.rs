...
const FLASH_CAPACITY_BYTES: usize = 16 * 1024 * 1024;
...
async fn main(_spawner: Spawner) {
    ...
    let mut head = [0u8; 16];
    flash.read_bytes(TEST_OFFSET, &mut head).unwrap();
    info!(
